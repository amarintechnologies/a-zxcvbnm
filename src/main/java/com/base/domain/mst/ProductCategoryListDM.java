...
@Entity
@Table(name = "VW_BASE_PRODUCT_CATEGORY")
public class ProductCategoryListDM implements Serializable {

	private static final long serialVersionUID = 3604451871438870366L;
	@Id
	...
	public ProductCategoryListDM() {
	}
	
	public ProductCategoryListDM(Long cateid, String catename) {
		this.cateid = cateid;
