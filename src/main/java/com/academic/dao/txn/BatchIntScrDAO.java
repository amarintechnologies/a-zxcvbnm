...
public interface BatchIntScrDAO {
	/**
	 ...
	 * 
	 * @param Long intrnlscoreId,String course_name, String batch_name, String firstName, String
	 *               internlName, Long studentId, BigDecimal score, String
	 *               status
	 */
