...
public interface AcdbatchDAO {
	 ...
	 */
	public List<AcdbatchDM> getmacdbatchList(Long batch_id, Long course_id, String batch_name, String batch_status,String batchYear,Long companyid);
}
