...
public interface BatchExamStudentsDAO {


	/**
	 * Used to save or update the Comments data into the database.      
	 * 
	 * @param BatchExamStudentDM examStudObj
	 *                    
	 */
	 ...
	 */
	public List<BatchExamStudentDM> getExamStudList(Long exStudId, Long exsubjId,
 Long studId, Date examDate, Long gradeId,
