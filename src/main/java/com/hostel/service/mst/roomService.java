package com.hostel.service.mst;
...
public interface roomService {
	 ...
	 * 
	 * @param Long room_id,Long hostel_id,Long company_id,String room_type,String status

	 * 
	 * @return list of roomDM
	 */
	public List<roomDM> getroomList(Long room_id,Long hostel_id,Long company_id,String room_type,String status);
